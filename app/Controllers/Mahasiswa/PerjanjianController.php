...
class PerjanjianController extends BaseController
{
    ...
    public function index()
    {
        ...
        } elseif (($proposal['pitching_admin_status'] ?? '') !== 'approved' || empty($proposal['pitching_final_at'])) {
            $isEligible = false;
            $reason = 'Anda harus menyelesaikan tahap Pitching Desk dan mendapatkan finalisasi dari Admin/UPAPKK terlebih dahulu.';
        }
    ...
    public function uploadSuratPernyataan()
    {
        ...
        $file = $this->request->getFile('surat_pernyataan_file');
        ...
        $docKey = 'surat_pernyataan_penerima_dana';
        ...
        if ($file->move($absTargetDir, $newName)) {
            ...
            return $this->respond([
                'success'  => true,
                'message'  => 'Surat pernyataan penerima dana berhasil diunggah.',
