...
<div class="space-y-8" x-data="{
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 animate-stagger">
        <div>
            ...
            <p class="section-subtitle text-[10px] sm:text-[11px]">Tahap 3 - Validasi PPT dan Link Video Tim Bimbingan Anda</p>
        </div>
    </div>
    ...
    <div class="flex flex-wrap gap-2 animate-stagger delay-300">
        <a href="<?= base_url('dosen/pitching-desk') ?>" 
        ...
        <a href="<?= base_url('dosen/pitching-desk?status=revision') ?>" 
        ...
        <div class="px-4 sm:px-7 py-4 sm:py-5 border-b border-sky-50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white/60">
            <div>
                ...
                <p class="text-[11px] text-(--text-muted) font-semibold mt-0.5">
                    Memvalidasi kelayakan PPT dan Video Pitching sebelum diajukan ke Admin
                </p>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="group">
                        ...
                        <td class="text-right whitespace-nowrap">
                            <a href="<?= base_url('dosen/pitching-desk/' . $proposal['id']) ?>" 
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-12">
                            <div class="text-(--text-muted)">
                                ...
                                <p class="text-sm">Tidak ada tim bimbingan yang membutuhkan validasi saat ini.</p>
                            </div>
                        </td>
                    </tr>
                    <?php endif; ?>
