...
<script>
    function openBiodataModal(type, data) {
        ...
        const shadowColor = 'shadow-teal-100';
        ...
        roleBadge.className = `inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-[9px] font-black border bg-teal-50 text-teal-600 border-teal-100`;
