...
<section id="section-tentang-hero" class="relative overflow-hidden hero-gradient hero-pattern">
    <div class="max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-20 lg:pt-28 relative z-10">
        <div class="text-center max-w-3xl mx-auto reveal-zoom">
            <p class="text-sky-500 font-semibold text-sm uppercase tracking-wider mb-4 stagger-1">
                <?= cms('tentang_hero_badge', 'Tentang Program') ?>
            </p>
            <h1 class="font-display text-4xl sm:text-6xl font-bold text-(--text-heading) mb-6 stagger-2 text-shimmer">
                <?= cms_split('tentang_hero_title', 2, 'Program Mahasiswa Wirausaha', 'start') ?>
            </h1>
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div class="reveal-left">
                ...
                <h2 class="font-display text-3xl lg:text-5xl font-bold text-(--text-heading) mb-8">
                    <?= cms_split('tentang_vision_title', 1, 'Mencetak Wirausaha Muda') ?>
                </h2>

                <div class="space-y-8">
                    <div class="flex gap-6 group">
                        <div
                            class="w-14 h-14 rounded-2xl bg-sky-100 flex items-center justify-center shrink-0 group-hover:scale-110 transition-liquid">
                    ...
                    <div class="flex gap-6 group">
                        <div
                            class="w-14 h-14 rounded-2xl bg-amber-100 flex items-center justify-center shrink-0 group-hover:scale-110 transition-liquid">
                            ...
                            <ul class="space-y-4">
                                ...
                                foreach ($missions as $idx => $mission): ?>
                                    <li class="flex items-start gap-3 reveal-on-scroll stagger-<?= ($idx % 5) + 1 ?>">
                                        <div
                                            class="mt-1 w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center shrink-0">
                                            <i class="fas fa-check text-emerald-500 text-[10px]"></i>
                                        </div>
                                        <span
                                            class="text-(--text-body)"><?= is_array($mission) ? ($mission['misi'] ?? ($mission['text'] ?? '')) : $mission ?></span>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
            ...
            <div class="relative reveal-right">
                <div
                    class="rounded-[2.5rem] overflow-hidden shadow-2xl rotate-2 hover:rotate-0 transition-liquid group">
                    <img src="<?= cms_img(cms('tentang_vision_image', 'https://images.unsplash.com/photo-1553877522-43269d4ea984?w=800&q=80')) ?>"
                ...
                <!-- Floating Stats Card -->
                <div
                    class="absolute -bottom-10 -left-10 glass-premium rounded-3xl p-8 shadow-2xl border-white/40 reveal-zoom stagger-4">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            foreach ($objectives as $idx => $obj):
                ...
                ?>
                <div
                    class="bg-white p-10 rounded-[2.5rem] border border-slate-100 reveal-zoom card-magnetic stagger-<?= ($idx % 3) + 1 ?> group hover:border-sky-300/50 transition-liquid">
                    <div
                        class="w-16 h-16 rounded-2xl <?= $bgColor ?> flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-6 transition-liquid">
                        <i class="fas <?= $obj['icon'] ?> <?= $iconColor ?> text-3xl"></i>
                    </div>
                    <h3
                        class="font-display text-2xl font-bold text-(--text-heading) mb-4 group-hover:text-sky-600 transition-colors">
                        <?= $obj['title'] ?>
                    </h3>
                    <p class="text-(--text-body) leading-relaxed">
                        <?= $obj['desc'] ?>
...
<section class="py-20 lg:py-32 overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
            ...
            <!-- Usaha Pemula -->
            <div
                class="bg-linear-to-br from-orange-50 to-amber-50 rounded-[3rem] p-10 lg:p-12 border border-orange-100 relative overflow-hidden reveal-left group hover:shadow-2xl hover:shadow-orange-200/50 transition-liquid">
                <div
                    class="absolute top-0 right-0 w-48 h-48 bg-orange-200/30 rounded-full -translate-y-1/2 translate-x-1/2 blur-2xl group-hover:scale-125 transition-transform duration-1000">
                </div>

                <div class="relative z-10">
                    <div
                        class="w-16 h-16 rounded-2xl bg-linear-to-br from-orange-400 to-amber-500 flex items-center justify-center mb-8 shadow-lg shadow-orange-200">
                    ...
                    <p class="text-(--text-body) mb-8 leading-relaxed text-lg">
                        Untuk peserta yang baru memiliki ide atau belum memiliki usaha. Fokus pada validasi ide dan
                    ...
                    <ul class="space-y-4 mb-10">
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <span class="font-medium text-slate-700">Individu atau Tim (minimal 2 orang)</span>
                        </li>
                    </ul>

                    <a href="<?= base_url('register') ?>"
                        class="btn-primary bg-orange-500 hover:bg-orange-600 border-none shadow-orange-200">Daftar Jalur
                        Pemula</a>
                </div>
            </div>
            ...
            <!-- Usaha Berkembang -->
            <div
                class="bg-linear-to-br from-emerald-50 to-teal-50 rounded-[3rem] p-10 lg:p-12 border border-emerald-100 relative overflow-hidden reveal-right group hover:shadow-2xl hover:shadow-emerald-200/50 transition-liquid">
                <div
                    class="absolute top-0 right-0 w-48 h-48 bg-emerald-200/30 rounded-full -translate-y-1/2 translate-x-1/2 blur-2xl group-hover:scale-125 transition-transform duration-1000">
                </div>

                <div class="relative z-10">
                    <div
                        class="w-16 h-16 rounded-2xl bg-linear-to-br from-emerald-500 to-teal-500 flex items-center justify-center mb-8 shadow-lg shadow-emerald-200">
                    ...
                    <p class="text-emerald-600 font-bold text-lg mb-6">Pendanaan hingga Rp 8.000.000</p>

                    <p class="text-(--text-body) mb-8 leading-relaxed text-lg">
                        Untuk peserta yang telah memiliki usaha dan ingin mengembangkan skala. Fokus pada ekspansi dan
                        optimalisasi bisnis.
                    </p>
                    ...
                    <ul class="space-y-4 mb-10">
                        <li class="flex items-center gap-3">
                            ...
                            <span class="font-medium text-slate-700">Usaha berjalan minimal 1 Tahun</span>
                        </li>
                        <li class="flex items-center gap-3">
                            <div class="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center shrink-0">
                                <i class="fas fa-check text-emerald-600 text-[10px]"></i>
                    ...
                    <a href="<?= base_url('register') ?>"
                        class="btn-primary bg-emerald-600 hover:bg-emerald-700 border-none shadow-emerald-200">Daftar
                        Jalur Berkembang</a>
                </div>
            </div>
        </div>
...
<section class="py-20 lg:py-32 bg-white relative overflow-hidden">
    <div class="absolute inset-0 opacity-10">
        <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-sky-500/20 rounded-full blur-[120px] animate-float">
        </div>
        <div class="absolute bottom-0 left-0 w-[500px] h-[500px] bg-emerald-500/10 rounded-full blur-[120px] animate-float"
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            foreach ($benefits as $idx => $ben):
                ...
                ?>
                <div
                    class="bg-slate-50 p-8 rounded-[2rem] border border-slate-100 hover:bg-white hover:border-sky-300/50 hover:shadow-2xl hover:shadow-sky-500/5 transition-liquid reveal-zoom stagger-<?= $idx + 1 ?> group">
                    <div
                        class="w-14 h-14 rounded-2xl <?= $bgColor ?> flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-liquid">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            foreach ($teams as $idx => $t): ?>
                <div
                    class="bg-white group p-8 rounded-[2.5rem] border border-slate-100 hover:border-sky-300/50 hover:shadow-2xl hover:shadow-sky-500/10 transition-liquid reveal-on-scroll stagger-<?= $idx + 1 ?>">
                    <div
                        class="w-16 h-16 rounded-2xl bg-<?= $t['color'] ?>-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-liquid">
...
<section id="section-tentang-cta" class="py-20 lg:py-32 relative overflow-hidden">
    ...
    <div class="max-w-5xl mx-auto px-6 lg:px-8 relative z-10">
        <div
            class="reveal-zoom glass-premium p-10 lg:p-20 rounded-[40px] border-white/20 shadow-2xl text-center backdrop-blur-2xl">
            ...
            <div class="flex flex-wrap justify-center gap-6">
                <a href="<?= base_url('register') ?>"
                    class="btn-accent btn-magnetic group px-10 py-5 text-lg shadow-xl shadow-amber-500/30">
                    <i
                        class="fas fa-paper-plane mr-3 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform"></i>
                    Daftar Sekarang
                </a>
                <a href="<?= base_url('tahapan') ?>"
                    class="btn-ghost btn-magnetic border-white/40 text-white hover:bg-white/10 px-10 py-5 text-lg">
