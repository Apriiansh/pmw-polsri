...
<div class="space-y-8 max-w-5xl mx-auto" x-data="pitchingDeskForm()">
    ...
    ================================================================= -->
        ...
        <?php if ($proposal['pitching_dosen_status'] === 'approved' && $proposal['pitching_admin_status'] === 'approved'): ?>
            <!-- ================================================================
                 Success Banner (Transition to Stage 4)
            ================================================================= -->
            <div class="card-premium bg-linear-to-br from-emerald-600 to-teal-600 animate-stagger delay-200 overflow-hidden" @mousemove="handleMouseMove">
                <div class="bg-white/10 backdrop-blur-md p-8 sm:p-10 rounded-[1.4rem] text-white flex flex-col items-center text-center gap-5 relative overflow-hidden">
                    ...
                    <div class="max-w-2xl relative z-10">
                        <h3 class="font-display text-2xl sm:text-3xl font-black mb-3 tracking-tight">Selamat <?= esc($proposal['ketua_nama'] ?? 'Tim Anda') ?>, Tim Anda Berhasil Lolos!</h3>
                        <p class="text-sm sm:text-base text-slate-500 font-medium leading-relaxed opacity-90">
                            Pitching Desk Anda telah <span class="font-black underline underline-offset-4 decoration-emerald-200 uppercase">Disetujui</span>.
                            Tim Anda sekarang dapat melanjutkan ke tahap penandatanganan perjanjian untuk meresmikan pendanaan.
                        </p>

                        <div class="mt-8 flex justify-center gap-4">
                            <a href="<?= base_url('mahasiswa/perjanjian') ?>" class="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-white text-emerald-700 font-black text-sm shadow-2xl shadow-emerald-900/20 hover:scale-105 hover:bg-emerald-50 transition-all group">
                                <i class="fas fa-file-signature text-lg text-teal-500 group-hover:rotate-12 transition-transform"></i>
    ...
    ================================================================= -->
        <?php if ($isBerkembang): ?>
            <div class="card-premium overflow-hidden animate-stagger delay-400 border-l-4 border-l-violet-500" @mousemove="handleMouseMove">
                ...
                <div class="p-5 sm:p-7 space-y-6">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="relative flex-1">
                                        ...
                                        <input type="url"
                                            ...
                                            :disabled="!<?= ($isPhaseOpen && !$isLocked) ? 'true' : 'false' ?> || isSavingVideo">
                                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="detail_keterangan" rows="5" class="form-textarea" x-model="detailKeterangan"
                            <?= $isLocked ? 'disabled' : '' ?>
                            placeholder="Jelaskan detail usaha Anda, produk/jasa yang ditawarkan, target pasar, keunggulan kompetitif, dll..."><?= esc($proposal['detail_keterangan'] ?? '') ?></textarea>
                        <?php if ($isPhaseOpen && !$isLocked): ?>
