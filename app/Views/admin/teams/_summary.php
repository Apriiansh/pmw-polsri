        ...
        <div class="space-y-6">
            <div class="card-premium p-6" @mousemove="handleMouseMove">
                ...
                <div class="flex items-center gap-4 mb-6">
                    <h3 class="text-lg font-black text-slate-800 uppercase tracking-tight">Tracking Progress</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="p-4 rounded-2xl bg-amber-50/50 border border-amber-100 border-l-4 border-l-amber-500">
                        <div class="flex items-center justify-between mb-2">
                            <div class="w-10 h-10 rounded-lg bg-white text-amber-500 flex items-center justify-center shadow-sm border border-amber-100">
                    ...
                    <div class="p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100 border-l-4 border-l-emerald-500">
                        <div class="flex items-center justify-between mb-2">
                            <div class="w-10 h-10 rounded-lg bg-white text-emerald-500 flex items-center justify-center shadow-sm border border-emerald-100">
                    ...
                    <div class="p-4 rounded-2xl bg-violet-50/50 border border-violet-100 border-l-4 border-l-violet-500">
                        <div class="flex items-center justify-between mb-2">
                            <div class="w-10 h-10 rounded-lg bg-white text-violet-500 flex items-center justify-center shadow-sm border border-violet-100">
