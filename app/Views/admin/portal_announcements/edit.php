...
<div class="max-w-4xl mx-auto">
    ...
    <form action="<?= base_url('admin/portal-announcements/update/' . $announcement['id']) ?>" method="POST" class="space-y-6">
        <?= csrf_field() ?>
        ...
        <div class="bg-white rounded-[2rem] border border-slate-200 p-8 shadow-sm">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" id="title" required value="<?= esc($announcement['title']) ?>"
                ...
                <div>
                    ...
                    <select name="category" required class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:bg-white focus:border-sky-500 outline-none transition-all">
                        ...
                        <option value="Jadwal" <?= $announcement['category'] === 'Jadwal' ? 'selected' : '' ?>>Jadwal</option>
                ...
                <div>
                    ...
                    <input type="date" name="date" required value="<?= $announcement['date'] ?>"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="content" rows="8" required placeholder="Tulis detail pengumuman di sini..."
                              class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:bg-white focus:ring-4 focus:ring-sky-500/10 focus:border-sky-500 outline-none transition-all resize-none shadow-inner leading-relaxed"><?= esc($announcement['content']) ?></textarea>
