    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'content' => json_encode([
                    ['misi' => 'Memfasilitasi mahasiswa dalam mengembangkan ide bisnis menjadi usaha nyata'],
                    ['misi' => 'Memberikan pendanaan dan akses permodalan untuk pengembangan usaha'],
                    ['misi' => 'Menyediakan mentoring dan pendampingan dari praktisi berpengalaman'],
                    ['misi' => 'Membangun ekosistem kewirausahaan yang kolaboratif dan berkelanjutan']
                ]),
                'type'    => 'json',
                'group'   => 'tentang_vision',
                'label'   => 'Mission List',
