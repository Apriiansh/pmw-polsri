...
class PmwActivityScheduleModel extends Model
{
    ...
    {
        return $this->select('pmw_activity_schedules.*, p.nama_usaha, pm.nama as ketua_nama, pal.status as logbook_status, pal.reviewer_summary, pal.reviewer_photo, pal.reviewer_at, pal.admin_summary, pal.admin_photo, pal.admin_at')
